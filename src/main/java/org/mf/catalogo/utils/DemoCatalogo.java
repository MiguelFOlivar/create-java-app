...
public class DemoCatalogo {
    public static void demoPeliculas() throws SQLException {
        ...
        img = new File("img"+File.separator+"cadena2.jpg");
        ...
        img = new File("img"+File.separator+"pez.jpg");
        ...
        img = new File("img"+File.separator+"forma.jpg");
        ...
        img = new File("img"+File.separator+"spiderwick.jpg");
        ...
        img = new File("img"+File.separator+"redfilm.jpg");
        ...
        img = new File("img"+File.separator+"sp2.jpg");
        ...
        img = new File("img"+File.separator+"ironman3.jpg");
        ...
        img = new File("img"+File.separator+"corleone.jpg");
